...
%                                set(handles.txStackEst,'string',num2str(SP))
                                ...
                                length(rt)
%                                length(tr)
                                plot(handles.grSenales,tr(1:L)-t(1),rt(1:L)/2^23*2.45,'red');
%                                figure
%                                plot(rt(1:L),'red');
...
%                                length(X.datos)
                            ...
                            if tipoSenal(2) == 1
                                ...
                                plot(handles.grSenales,senalF.tiempo-t,senalF.datos,'blue');
                                hold(handles.grSenales,'on');
...
%                                plot(handles.grSenales,X.tiempo-t,rtA(1:length(X.datos)),'red');
                                hold(handles.grSenales,'on');
                                plot(handles.grSenales,X.tiempo-t,rt(1:length(X.datos)),'m');
                                %set(handles.grSenales,'Xlim',xlim);
                                %set(handles.grSenales,'Ylim',ylim);
